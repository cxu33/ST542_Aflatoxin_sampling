...
## Fig X: Consumer's risk at different combos ----------------------------------------------------------
...
ggsave(filename = "figs/Figure_X_consumers_risk_vs_num_railcars_per_composite_facet_scale.png", width = 8, height = 5)


## Fig X: Demonstrate severity of the problem ------------------------------
...
## Fig X: Average number of unsafe railcars ----------------------------------------------------------
...
ggsave(filename = "figs/Figure_X_avg_num_unsafe_railcars_in_accepted_trainloads.png", width = 8, height = 5)
...
## Fig X: consumers risk vs avg num unsafe accepted -----------------
